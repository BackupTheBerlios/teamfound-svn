...
\section{Individuelle Sichtweisen}
\subsection{Organisation und Kommunikation by Jonas}
...
Heute, einen Tag vor Abgabe, h"orte ich soeben von Martin, da"s die Update-Funktionalit"at nun auch funktioniert (w"ahrend ich selber diesen Text hier schreibe).

Sieht so aus als w"urde alles \textit{just in time} fertig werden!
