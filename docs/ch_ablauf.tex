...
\item Mailingliste \texttt{teamfound-development@lists.berlios.de} - zum subscriben/unsubscriben folgenden Link benutzen: \texttt{https://lists.berlios.de/mailman/listinfo/teamfound-development}
...
\item[SVN server] svn.berlios.de
