...
war \index{CodeProject}CodeProject (www.codeproject.com). 
...
für die Entwicklung von \index{BandObjects}BandObjects, also Band Objekten (http://www.codeproject.com/csharp/dotnetbandobjects.asp).
...
Für die Installation auf einem \index{Client}Client PC kopiert man alle im Paket enthaltenen \index{Quellen}Quellen in einen Ordner.
Die \index{Toolbar}Toolbar lässt dann einfach mit dem \index{Install.cmd}Install.cmd installieren. Im wesentlichen passiert dabei folgendes:

Die Bibliotheken \index{IE Toolbar!BandObject.dll}BandObject.dll und \index{IE Toolbar!Teamfound.IE.dll}Teamfound.IE.dll werden als COM Objekt registriert und im globalen Assembly Cache registriert. 
